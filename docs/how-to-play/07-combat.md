...
*   **Armour Shift:** Heavy units take less damage from light units.
...
> **Strategy Tip:** Timing is everything. Coordinate your attacks to clear a path, then have a fast reserve fleet move through the gap on the very next hour (Tick).
