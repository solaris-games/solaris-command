...
export interface CombatResultEntry {
  attacker: {
    ...
    disorganised: boolean; // Regroup after combat
  };
  defender: {
    losses: number;
    suppressed: number;
...
export const COMBAT_RESULTS_TABLE: Record<number, CombatResultEntry> = {
  ...
  [-3]: {
    attacker: { losses: 5, suppressed: 0, disorganised: true },
    defender: { losses: 0, suppressed: 0, disorganised: false, retreat: false },
    resultType: CombatResultType.MISS,
  },

  // --- Defender Edge (-2) ---
  [-2]: {
    attacker: { losses: 4, suppressed: 0, disorganised: true },
    defender: { losses: 0, suppressed: 1, disorganised: true, retreat: false },
    resultType: CombatResultType.MISS,
  },

  // --- Slight Defender Edge (-1) ---
  [-1]: {
    attacker: { losses: 3, suppressed: 0, disorganised: true },
    defender: { losses: 0, suppressed: 2, disorganised: true, retreat: false },
  ...
  0: {
    attacker: { losses: 2, suppressed: 0, disorganised: true },
    defender: { losses: 1, suppressed: 3, disorganised: true, retreat: false },
    resultType: CombatResultType.SUPPRESS,
  },

  // --- Slight Attacker Edge (+1) ---
  1: {
    attacker: { losses: 1, suppressed: 0, disorganised: true },
    defender: { losses: 1, suppressed: 3, disorganised: true, retreat: false },
    resultType: CombatResultType.SUPPRESS,
  },
  ...
  8: {
    ...
    defender: { losses: 4, suppressed: 3, disorganised: true, retreat: true },
    resultType: CombatResultType.OVERRUN,
  },

  9: {
    attacker: { losses: 0, suppressed: 0, disorganised: false },
    defender: { losses: 5, suppressed: 3, disorganised: true, retreat: true },
    resultType: CombatResultType.OVERRUN,
  },
};

export const COMBAT_RESULT_FORCED_FEINT_ATTACK = {
  attacker: { losses: 0, suppressed: 1, disorganised: true },
  defender: { losses: 0, suppressed: 1, disorganised: false, retreat: false },
  resultType: CombatResultType.SUPPRESS,
};
