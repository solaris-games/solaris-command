<template>
    <div class="d-flex align-items-center">
        ...
        <div class="flex-grow-1 ms-3">
            Unit {{ unitName }} movement bounced at {{ (event.data as any).toHexLocation.q }}, {{ (event.data as any).toHexLocation.r }}.
        </div>
    </div>
</template>
...
const unitName = computed(() => {
    const unit = galaxyStore.units.find(u => u._id === (props.event.data as any).unitId);
